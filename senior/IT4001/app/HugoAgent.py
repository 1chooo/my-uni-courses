...
def detect_all_cubes(scene_info_file_path: str) -> str:
    ...
    try:
        ...
        #         ''')
#         print("Get Image Successfully and Ready to detect all cubes!!!")
        ...
        if decoded_list is not None:
            ...
            if cubes == "Error:No object in view.":
                result = f"""\
...
def pick_up_specific_cube(specific_cube: dict):
    ...
    You need to include the information of position, \
    orientation, feature.
