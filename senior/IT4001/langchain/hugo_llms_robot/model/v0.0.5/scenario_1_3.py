...
scenario1_3 = f"""
Place the black cubes in Area A.
"""
...
with get_openai_callback() as cb:
    agent_executor(
        f"""
        As the {role} you are, now your mission is to achieve the {scenario1_3}.
        Then you have to follow the steps that you have breaked down to use 
        the specific tools then achieve the {scenario1_3}.
        
        The information about A area is {A_area}, and B area is {B_area}.
        Each cube should be placed with a 0.05 spacing between them.
