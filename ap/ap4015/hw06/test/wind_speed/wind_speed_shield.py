...
# Plot wind speed as arrows
lat = np.linspace(17, 30, nlat)
lon = np.linspace(114, 130, mlon)
lon, lat = np.meshgrid(lon, lat)

stride = 10  # Adjust the stride to control the density of arrows
m.quiver(lon, lat, u[1, ::stride, ::stride], v[1, ::stride, ::stride], WS[1, ::stride, ::stride],
         cmap='rainbow', angles='xy', scale_units='xy', scale=0.5)
...
plt.title('Map of Taiwan with Wind Speed Field', fontsize=20)
