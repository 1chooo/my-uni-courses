...
export function preparePSPlatformBarChartDataGlobal(videoGameData) {
    console.log(videoGameData);

    const filteredData = videoGameData.filter(d => d.Platform === "PS4" || d.Platform === "PS3" || d.Platform === "PS2" || d.Platform === "PS");
...
export function preparePSPlatformBarChartData(videoGameData) {
    console.log(videoGameData);
