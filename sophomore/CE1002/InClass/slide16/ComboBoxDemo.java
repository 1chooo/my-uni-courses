...
public class ComboBoxDemo extends Application {
  ...
  private ImageView[] flagImage = {new ImageView("slide16/ca.gif"),
    new ImageView("slide16/china.gif"), 
    new ImageView("slide16/denmark.gif"), 
    new ImageView("slide16/fr.gif"), 
    new ImageView("slide16/germany.gif"),
    new ImageView("slide16/india.gif"), 
    new ImageView("slide16/norway.gif"),
    new ImageView("slide16/uk.gif"), 
    new ImageView("slide16/us.gif")};
  ...
  public void start(Stage primaryStage) {
	for(int i = 0; i < flagImage.length; i++) {
		flagImage[i].setFitHeight(100);
		flagImage[i].setFitWidth(150);
	}
